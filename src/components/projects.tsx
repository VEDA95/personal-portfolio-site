    ...
    return (
        <Waypoint onEnter={handleEnter}>
            <div className="flex flex-col w-full py-20 items-center">
                <animated.ul
                    className="grid gap-4 w-3/4 transition-opacity transform-gpu auto-rows-[25rem] grid-cols-[repeat(2,_50%)] md:grid-cols-[repeat(auto-fill,_18.75rem)] justify-center"
                    style={springStyles}>
